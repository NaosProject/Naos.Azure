...
namespace Naos.Azure.Domain.Test
{
    ...
    public static partial class ConnectionStringBlobContainerResourceLocatorTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ConnectionStringBlobContainerResourceLocator> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ConnectionStringBlobContainerResourceLocator>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'containerName' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "containerName", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "constructor should throw ArgumentException when parameter 'containerName' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ConnectionStringBlobContainerResourceLocator>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "containerName", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'connectionString' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ConnectionStringBlobContainerResourceLocator>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "connectionString", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "constructor should throw ArgumentException when parameter 'connectionString' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ConnectionStringBlobContainerResourceLocator>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "connectionString", "white space", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<ConnectionStringBlobContainerResourceLocator> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ConnectionStringBlobContainerResourceLocator>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "ContainerName should return same 'containerName' parameter passed to constructor when getting",
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "ConnectionString should return same 'connectionString' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ConnectionStringBlobContainerResourceLocator>();
        ...
        private static readonly DeepCloneWithTestScenarios<ConnectionStringBlobContainerResourceLocator> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ConnectionStringBlobContainerResourceLocator>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithContainerName should deep clone object and replace ContainerName with the provided containerName",
                    WithPropertyName = "ContainerName",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ConnectionStringBlobContainerResourceLocator>();

                        var referenceObject = A.Dummy<ConnectionStringBlobContainerResourceLocator>().ThatIs(_ => !systemUnderTest.ContainerName.IsEqualTo(_.ContainerName));

                        var result = new SystemUnderTestDeepCloneWithValue<ConnectionStringBlobContainerResourceLocator>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ContainerName,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "DeepCloneWithConnectionString should deep clone object and replace ConnectionString with the provided connectionString",
                    WithPropertyName = "ConnectionString",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ConnectionStringBlobContainerResourceLocator>();

                        var referenceObject = A.Dummy<ConnectionStringBlobContainerResourceLocator>().ThatIs(_ => !systemUnderTest.ConnectionString.IsEqualTo(_.ConnectionString));

                        var result = new SystemUnderTestDeepCloneWithValue<ConnectionStringBlobContainerResourceLocator>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ConnectionString,
                        };
        ...
        private static readonly EquatableTestScenarios<ConnectionStringBlobContainerResourceLocator> EquatableTestScenarios = new EquatableTestScenarios<ConnectionStringBlobContainerResourceLocator>()
            .AddScenario(() =>
                new EquatableTestScenario<ConnectionStringBlobContainerResourceLocator>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ConnectionStringBlobContainerResourceLocator[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void ConnectionStringBlobContainerResourceLocator___Should_implement_IModel_of_ConnectionStringBlobContainerResourceLocator___When_reflecting()
            {
                // Arrange
                var type = typeof(ConnectionStringBlobContainerResourceLocator);

                var expectedModelMethods = typeof(IModel<ConnectionStringBlobContainerResourceLocator>).GetInterfaceDeclaredAndImplementedMethods();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ConnectionStringBlobContainerResourceLocator___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ConnectionStringBlobContainerResourceLocator);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ConnectionStringBlobContainerResourceLocator)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ConnectionStringBlobContainerResourceLocator)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ConnectionStringBlobContainerResourceLocator).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ConnectionStringBlobContainerResourceLocator>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ConnectionStringBlobContainerResourceLocator systemUnderTest1 = null;
                ConnectionStringBlobContainerResourceLocator systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ConnectionStringBlobContainerResourceLocator systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ConnectionStringBlobContainerResourceLocator___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ConnectionStringBlobContainerResourceLocator___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ConnectionStringBlobContainerResourceLocator___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ConnectionStringBlobContainerResourceLocator___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ConnectionStringBlobContainerResourceLocator___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
