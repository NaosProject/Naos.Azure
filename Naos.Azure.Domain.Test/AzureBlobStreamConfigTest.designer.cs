...
namespace Naos.Azure.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AzureBlobStreamConfig> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AzureBlobStreamConfig>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AzureBlobStreamConfig>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AzureBlobStreamConfig>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AzureBlobStreamConfig>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Azure.Domain.AzureBlobStreamConfig: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, AccessKinds = {systemUnderTest.AccessKinds.ToString() ?? "<null>"}, DefaultSerializerRepresentation = {systemUnderTest.DefaultSerializerRepresentation?.ToString() ?? "<null>"}, DefaultSerializationFormat = {systemUnderTest.DefaultSerializationFormat.ToString() ?? "<null>"}, AllLocators = {systemUnderTest.AllLocators?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AzureBlobStreamConfig> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AzureBlobStreamConfig>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AzureBlobStreamConfig>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'name' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AzureBlobStreamConfig>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<AzureBlobStreamConfig> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AzureBlobStreamConfig>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AzureBlobStreamConfig>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<AzureBlobStreamConfig>
                        {
                            SystemUnderTest = new AzureBlobStreamConfig(
                                                      referenceObject.Name,
                                                      referenceObject.AccessKinds,
                                                      referenceObject.DefaultSerializerRepresentation,
                                                      referenceObject.DefaultSerializationFormat,
        ...
        private static readonly DeepCloneWithTestScenarios<AzureBlobStreamConfig> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AzureBlobStreamConfig>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AzureBlobStreamConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AzureBlobStreamConfig>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<AzureBlobStreamConfig>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AzureBlobStreamConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AzureBlobStreamConfig>().ThatIs(_ => !systemUnderTest.AccessKinds.IsEqualTo(_.AccessKinds));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AzureBlobStreamConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AzureBlobStreamConfig>().ThatIs(_ => !systemUnderTest.DefaultSerializerRepresentation.IsEqualTo(_.DefaultSerializerRepresentation));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AzureBlobStreamConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AzureBlobStreamConfig>().ThatIs(_ => !systemUnderTest.DefaultSerializationFormat.IsEqualTo(_.DefaultSerializationFormat));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AzureBlobStreamConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AzureBlobStreamConfig>().ThatIs(_ => !systemUnderTest.AllLocators.IsEqualTo(_.AllLocators));
        ...
        private static readonly AzureBlobStreamConfig ReferenceObjectForEquatableTestScenarios = A.Dummy<AzureBlobStreamConfig>();

        private static readonly EquatableTestScenarios<AzureBlobStreamConfig> EquatableTestScenarios = new EquatableTestScenarios<AzureBlobStreamConfig>()
            .AddScenario(() =>
                new EquatableTestScenario<AzureBlobStreamConfig>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AzureBlobStreamConfig[]
                    {
                    ...
                    {
                        new AzureBlobStreamConfig(
                                A.Dummy<AzureBlobStreamConfig>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name,
                                ReferenceObjectForEquatableTestScenarios.AccessKinds,
                                ReferenceObjectForEquatableTestScenarios.DefaultSerializerRepresentation,
                                ReferenceObjectForEquatableTestScenarios.DefaultSerializationFormat,
                                (IReadOnlyCollection<ConnectionStringBlobContainerResourceLocator>)ReferenceObjectForEquatableTestScenarios.AllLocators),
        ...
        public static class Structural
        {
            ...
            public static void AzureBlobStreamConfig___Should_implement_IModel_of_AzureBlobStreamConfig___When_reflecting()
            {
                // Arrange
                var type = typeof(AzureBlobStreamConfig);

                var expectedModelMethods = typeof(IModel<AzureBlobStreamConfig>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AzureBlobStreamConfig>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AzureBlobStreamConfig___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AzureBlobStreamConfig);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AzureBlobStreamConfig)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AzureBlobStreamConfig)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AzureBlobStreamConfig).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AzureBlobStreamConfig>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AzureBlobStreamConfig systemUnderTest1 = null;
                AzureBlobStreamConfig systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AzureBlobStreamConfig systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AzureBlobStreamConfig___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AzureBlobStreamConfig___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AzureBlobStreamConfig___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AzureBlobStreamConfig___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AzureBlobStreamConfig___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
